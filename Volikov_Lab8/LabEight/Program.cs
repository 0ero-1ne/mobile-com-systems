...
namespace labEight
{
    static class Task1
    {
        ...
        {
            int losing_bits = 9;    // кол-во потерянных бит после функции ErrorsGenerator примененной к перемеженной строке
            ...
            Console.WriteLine("Число потерянных бит: " + (losing_bits + 1));
            return after_losing;
        }
    }
    ...
    class Program
    {
        static void Main()
        {
            string input = "ВоликовДмитрийАнатольевич_група7"; // 32 бита
